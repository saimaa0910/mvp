# 🔌 API Specification: Patient Demographic & Identity APIs
## Namma Clinic Digital Health & Operations Platform
**Document Code:** API-DOC-05 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Domain Specification & Technical Scope
Endpoints: POST `/patients`, GET `/patients/search`, GET `/patients/{id}`, PUT `/patients/{id}`.
