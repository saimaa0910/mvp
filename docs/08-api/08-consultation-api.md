# 🔌 API Specification: Doctor Clinical Consultation APIs
## Namma Clinic Digital Health & Operations Platform
**Document Code:** API-DOC-08 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Domain Specification & Technical Scope
Endpoints: POST `/visits/{id}/consultation`, GET `/visits/{id}/history`, GET `/diagnoses/search`.
