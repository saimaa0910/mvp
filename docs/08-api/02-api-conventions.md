# 🔌 API Specification: API Conventions & Standard Response Envelopes
## Namma Clinic Digital Health & Operations Platform
**Document Code:** API-DOC-02 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Domain Specification & Technical Scope
Unified payload format: `{'success': true, 'data': {...}, 'error': null, 'meta': {...}}`.
