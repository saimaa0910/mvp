# 🔌 API Specification: Citizen Notification & SMS APIs
## Namma Clinic Digital Health & Operations Platform
**Document Code:** API-DOC-14 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Domain Specification & Technical Scope
Endpoints: POST `/notifications/send-sms`, GET `/notifications/status/{id}`.
