# 🔌 API Specification: Open Data Portability & Export APIs
## Namma Clinic Digital Health & Operations Platform
**Document Code:** API-DOC-18 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Domain Specification & Technical Scope
Endpoints: POST `/portability/export-patient-data` (JSON / FHIR R4 standard).
