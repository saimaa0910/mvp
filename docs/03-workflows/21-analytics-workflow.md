# 🔄 Workflow: Public Health Data Extraction & Zonal Dashboard Refresh
## Namma Clinic Digital Health & Operations Platform
**Document Code:** WF-21 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Workflow Overview & Architecture
This document defines the end-to-end operational, technical, and data flow for **Public Health Data Extraction & Zonal Dashboard Refresh**.
...
Daily ELT aggregation of clinic encounters into Star Schema for epidemiological tracking.
