# 🔄 Workflow: Rapid Patient Search & Identity Verification
## Namma Clinic Digital Health & Operations Platform
**Document Code:** WF-04 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Workflow Overview & Architecture
This document defines the end-to-end operational, technical, and data flow for **Rapid Patient Search & Identity Verification**.
...
Search patient by Phone, UHID, ABHA ID with fast trigram matching.
