# 🔄 Workflow: Dynamic Queue Management & Doctor Room Routing
## Namma Clinic Digital Health & Operations Platform
**Document Code:** WF-08 | **Status:** Approved Baseline | **Date:** September 2026

---

### 1. Workflow Overview & Architecture
This document defines the end-to-end operational, technical, and data flow for **Dynamic Queue Management & Doctor Room Routing**.
...
Maintain real-time queue states (Waiting, In-Consultation, Lab-Pending, Completed).
