# Enterprise Release Specification: RELEASE-03 — Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals
## Namma Clinic Digital Health & Operations Platform
### Greater Bengaluru Authority (GBA) / BBMP Health Department
**Document Code:** `REL-DOC-03` | **Version Tag:** `v0.4.0-beta` | **Status:** APPROVED BASELINE | **Date:** September 2026

---

## 1. Document Control
Formal document governance metadata for `RELEASE-03` specification:

| Metadata Attribute | Governance Value | Description |
| :--- | :--- | :--- |
| **Document Identifier** | `REL-DOC-03` | Authoritative specification container for RELEASE-03 |
| **Release Tag** | `v0.4.0-beta` | Immutable Semantic Versioning (SemVer 2.0.0) tag |
| **Release Codename** | `Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals` | Official program release title |
| **Target Horizon** | Sprints SPRINT-09 to SPRINT-13 | Execution sprint container |
...
## 2. Release Identity
Core technical identity and architectural parameters for `RELEASE-03`:
- **Release Identifier:** `RELEASE-03`
- **Release Version:** `v0.4.0-beta`
- **Strategic Focus Theme:** Ancillary Care, Diagnostic Investigations & Referral Continuity
- **Predecessor Release Vehicle:** `RELEASE-02`
- **Successor Release Vehicle:** `RELEASE-04`
- **Target Deployment Cadence:** Automated Kubernetes blue/green rolling deployment.

## 3. Release Purpose
The primary purpose of `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) is to deliver ancillary workflows: barcode-driven fefo pharmacy dispensing, real-time inventory deductions, rapid diagnostic lab order processing, analyzer interfacing, and secondary hospital referral linkages. This release vehicle delivers an integrated, verified, and hardened milestone package, transitioning completed sprint outputs into production-grade capabilities.

## 4. Business Context
Operating across the municipal healthcare landscape of Bengaluru, the Namma Clinic Platform delivers high-quality primary healthcare services to urban communities. Release `RELEASE-03` provides the specific capabilities required to support clinical staff, reduce patient waiting times, eliminate manual paper logs, and enforce strict regulatory compliance with the Digital Personal Data Protection (DPDP) Act 2023.

## 5. Business Value
The strategic and operational business value realized through `RELEASE-03` includes:
- **Clinical Quality & Safety:** Eliminates medication stockouts via First-Expiry-First-Out allocation, streamlines rapid diagnostic testing, and connects primary clinics to tertiary secondary hospitals.
...
The measurable engineering and clinical delivery objectives for `RELEASE-03` are:
...
## 7. Release Scope
The operational scope of `RELEASE-03` encompasses:
- **Functional Scope:** Pharmacy dispensing counter, batch-level FEFO deduction, stockout warning system, POC rapid test ordering, laboratory specimen labeling, result entry, referral letter generation, and NIC eHospital gateway linking.
...
## 8. Out-of-Scope
The following capabilities are explicitly declared out-of-scope for `RELEASE-03`:
...
Analysis of operational impacts on key program stakeholders for `RELEASE-03`:
...
## 10. Persona Impact
Direct operational impacts on frontline personas during `RELEASE-03`:
...
## 11. Role Impact
Impacts and accountabilities across the 17 engineering and operational delivery roles for `RELEASE-03`:
- **Product Manager:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Solution Architect:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Technical Lead:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Backend Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Frontend Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Database Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **QA Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Security Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **DevOps Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Clinical SME:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Integration Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.
- **Support/Operations:** Responsible for architectural design, code implementation, test automation, and sign-off for Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals.

## 12. Capability Map
Architectural capability mapping for `RELEASE-03` across core platform pillars:
### Architecture Diagram: Capability Hierarchy for RELEASE-03
<!-- DOCUMENTATION-ONLY DIAGRAM -->
```mermaid
graph TD
    subgraph Release_Capabilities [RELEASE-03: Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals]
...
## 13. Feature Map
Complete product feature allocation and verification matrix across all 180 platform product features for `RELEASE-03`:
...
## 14. Epic Map
Delivery epics linked to `RELEASE-03` increment:

- **Epic Identifier:** `EPIC-016` | Scope: `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-017` | Scope: `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-018` | Scope: `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-019` | Scope: `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-020` | Scope: `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE

## 15. Requirement Traceability
Upstream functional and non-functional requirements satisfied by `RELEASE-03`:

- **Requirement ID:** `FR-013` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `FR-014` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `FR-015` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `FR-016` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `INT-001` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `INT-002` — Verified against Phase 02 Requirements baseline with full coverage.

## 16. Workflow Traceability
Operational workflows realized in `RELEASE-03`:
...
Architectural components instantiated and verified in `RELEASE-03`:
- **Component:** `Pharmacy Engine` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `FEFO Allocator` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `Lab Investigation Service` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `Referral Gateway` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `Notification Worker` — Aligned with Phase 06 Software Architecture specification.

## 18. Database Traceability
Complete database schema lineage across all 52 platform relational tables for `RELEASE-03`:
...
## 19. API Traceability
OpenAPI 3.1 REST API endpoint contracts delivered and verified in `RELEASE-03`:

- **API Family:** `Pharmacy API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Laboratory API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Referral API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Inventory API` — Fastify route handlers with schema-validated input payloads.

### Configuration Specification Example: OpenAPI Contract for RELEASE-03
<!-- DOCUMENTATION-ONLY EXAMPLE -->
```yaml
# DOCUMENTATION-ONLY CONFIGURATION
# DOCUMENTATION-ONLY CONFIGURATION: API Endpoint Contract for RELEASE-03
openapi: 3.1.0
info:
  title: Namma Clinic RELEASE-03 API
  version: "v0.4.0-beta"
paths:
  /api/v1/release-03/status:
    get:
...
User interface modules and bilingual UX components delivered in `RELEASE-03`:
- **UI Module:** `Pharmacy Dispensing Counter` — Built with React, TailwindCSS, and verified Kannada/English string tokens.
- **UI Module:** `Lab Technician Console` — Built with React, TailwindCSS, and verified Kannada/English string tokens.
- **UI Module:** `Referral Coordinator View` — Built with React, TailwindCSS, and verified Kannada/English string tokens.

## 21. Security Traceability
Zero-trust security controls and cryptographic perimeters enforced in `RELEASE-03`:
- **Security Control:** `Pharmacist double-signature verification` — Compliant with Phase 10 Security Architecture.
- **Security Control:** `Audit trail of medication substitution` — Compliant with Phase 10 Security Architecture.
- **Security Control:** `Encrypted referral transfer` — Compliant with Phase 10 Security Architecture.

## 22. QA Traceability
Multi-tier quality assurance and automated test verification for `RELEASE-03`:
- **QA Strategy:** End-to-end integration tests verifying prescription-to-dispensation inventory decrement.
...
CI/CD deployment pipelines, container images, and infrastructure manifests for `RELEASE-03`:
- **DevOps Controls:** RabbitMQ / BullMQ message queues handling asynchronous referral notifications and SMS dispatch.
- **Container Artifact:** Signed OCI container images published to GitHub Container Registry.

## 24. Data Traceability
Data engineering pipelines and lakehouse synchronization for `RELEASE-03`:
- **Data Capabilities:** Daily drug stock burn rate and antibiotic consumption metrics.
- **Audit Logging:** Immutable WORM ledger recording all state transitions.

## 25. AI Traceability
Artificial intelligence and clinical decision support governance for `RELEASE-03`:
- **AI Capabilities:** None in ancillary execution tier.
- **Clinical Primacy:** Mandatory physician oversight; zero autonomous treatment algorithms.

## 26. Integration Traceability
External partner interfaces and gateway adapters configured for `RELEASE-03`:
- **Integration Gateway:** `NIC eHospital Referral Service` — WireMock mock stubs active in local development.
- **Integration Gateway:** `CDAC SMS Gateway` — WireMock mock stubs active in local development.
- **Integration Gateway:** `Laboratory Analyzer RS-232 Bridge` — WireMock mock stubs active in local development.

## 27. Sprint Mapping
Sprint increments constituting `RELEASE-03`:
...
Critical upstream and cross-squad dependencies for `RELEASE-03`:
...
## 29. Risk Mapping
Delivery and operational risks managed for `RELEASE-03`:
...
## 30. Blocker Mapping
Potential blockers and decoupled workarounds for `RELEASE-03`:
...
- **Impacted Scope:** Components linked to Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals release increment.
...
Master program milestones verified upon `RELEASE-03` completion:
...
## 32. Entry Criteria
Definition of Ready (DoR) required before entering `RELEASE-03` deployment phase:
- RELEASE-02 Clinical Consultation certified and generating valid e-prescriptions in staging.
- All pull requests reviewed by at least two senior engineers.
- Zero unhandled lint or formatting errors in source repository.

## 33. Exit Criteria
Definition of Done (DoD) required for `RELEASE-03` production promotion:
- 1,000 pharmacy dispensations and 500 lab orders processed with 100% stock reconciliation and zero expired batch issuances.
...
Operational and facility readiness parameters for `RELEASE-03`:
- Pilot clinic pharmacy counters equipped with 2D barcode scanners and thermal label printers.
- Staging load test validates sub-250ms p95 latency under simulated peak load.

## 35. Quality Gates
Automated quality gates enforced for `RELEASE-03` in CI/CD pipeline:
...
## 36. Security Gates
Security validation gates for `RELEASE-03`:
- Secure token authentication active between clinic gateway and NIC eHospital.
- SAST, DAST, and container vulnerability scans completed with passing grade.

## 37. Data Gates
Database migration and data readiness gates for `RELEASE-03`:
- Comprehensive laboratory test catalog (24 tests) and reference ranges verified.
- Flyway migrations execute cleanly; reversible undo scripts tested in staging.

## 38. Operational Gates
SRE operational readiness gates for `RELEASE-03`:
- Pilot clinic drug stock physically audited and initial batch inventory seeded.
- Kubernetes liveness (`/healthz`) and readiness (`/readyz`) probes configured.

## 39. Training Gates
Frontline staff enablement gates for `RELEASE-03`:
- Pharmacist and lab technician training sessions completed across 20 pilot clinics.
- Bilingual user training guides distributed to participating clinic staff.

## 40. Support Gates
Helpdesk and support infrastructure gates for `RELEASE-03`:
- Dedicated inventory and lab hardware support queue operational.
- On-call rotation established and emergency escalation matrix published.

## 41. Deployment Strategy
Blue/Green zero-downtime deployment mechanism for `RELEASE-03`:
...
Automated and manual rollback protocols for `RELEASE-03`:
- **Rollback Trigger Criteria:** Automated rollback if inventory concurrency locks cause transaction deadlocks during load testing.
...
Formal decision governance for `RELEASE-03` deployment:
...
Formal acceptance criteria governing `RELEASE-03` sign-off:
- Pharmacist dispenses verified e-prescription and deducts batch stock in under 45 seconds with zero discrepancy.

## 45. Metrics
Technical and engineering performance metrics monitored for `RELEASE-03`:
...
## 46. KPIs
Key public health and operational performance indicators for `RELEASE-03`:
...
Operating governance framework for `RELEASE-03`:
...
Standard change management procedures for `RELEASE-03`:
...
Stakeholder communication schedule for `RELEASE-03`:
...
Post-release validation protocol executed immediately following `RELEASE-03` cutover:
...
## 51. Hypercare
Dedicated hypercare support model for `RELEASE-03`:
...
## 52. Lessons Learned
Continuous improvement review protocol for `RELEASE-03`:
...
Multi-dimensional traceability matrix linking `RELEASE-03` across program dimensions:

| Dimension | Upstream Identifier | Verification Status |
| :--- | :--- | :--- |
| **Governing Sprints** | SPRINT-09, SPRINT-11, SPRINT-12, SPRINT-13 | VERIFIED & LINKED |
| **Governing Epics** | EPIC-016, EPIC-017, EPIC-018, EPIC-019 | VERIFIED & LINKED |
| **Primary Database Tables** | TABLE-031, TABLE-032, TABLE-033, TABLE-034, TABLE-035 | VERIFIED & LINKED |
| **Primary Requirements** | FR-013, FR-014, FR-015, FR-016 | VERIFIED & LINKED |
| **Primary Workflows** | WF-012, WF-013, WF-014, WF-015, WF-016 | VERIFIED & LINKED |
| **Target Milestones** | MILESTONE-007, MILESTONE-008 | VERIFIED & LINKED |

## 54. Release Completion Checklist
20-point exhaustive release readiness checklist certifying completion of `RELEASE-03`:
...
The Enterprise Release Specification for `RELEASE-03` (Pharmacy Dispensing, Point-of-Care Laboratory & Secondary Referrals) has been formally reviewed, certified, and approved for execution:

| Authority Body | Designated Officer | Certification Status for RELEASE-03 |
| :--- | :--- | :--- |
| **Chief Technology Officer** | Chief Technology Officer | `APPROVED & CERTIFIED (RELEASE-03)` |
| **Lead Systems Architect** | Lead Solutions Architect | `APPROVED & CERTIFIED (RELEASE-03)` |
| **Lead Clinical SME** | Chief Medical Officer | `APPROVED & CERTIFIED (RELEASE-03)` |
| **Director of Health Services** | Joint Commissioner of Health | `APPROVED & CERTIFIED (RELEASE-03)` |
