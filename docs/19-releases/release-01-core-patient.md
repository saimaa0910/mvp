# Enterprise Release Specification: RELEASE-01 — Core Patient Registration, Queue Management & Digital Consent
## Namma Clinic Digital Health & Operations Platform
### Greater Bengaluru Authority (GBA) / BBMP Health Department
**Document Code:** `REL-DOC-01` | **Version Tag:** `v0.2.0-beta` | **Status:** APPROVED BASELINE | **Date:** September 2026

---

## 1. Document Control
Formal document governance metadata for `RELEASE-01` specification:

| Metadata Attribute | Governance Value | Description |
| :--- | :--- | :--- |
| **Document Identifier** | `REL-DOC-01` | Authoritative specification container for RELEASE-01 |
| **Release Tag** | `v0.2.0-beta` | Immutable Semantic Versioning (SemVer 2.0.0) tag |
| **Release Codename** | `Core Patient Registration, Queue Management & Digital Consent` | Official program release title |
| **Target Horizon** | Sprints SPRINT-03 to SPRINT-05 | Execution sprint container |
...
## 2. Release Identity
Core technical identity and architectural parameters for `RELEASE-01`:
- **Release Identifier:** `RELEASE-01`
- **Release Version:** `v0.2.0-beta`
- **Strategic Focus Theme:** Frontline Patient Intake & Queue Orchestration
- **Predecessor Release Vehicle:** `RELEASE-00`
- **Successor Release Vehicle:** `RELEASE-02`
- **Target Deployment Cadence:** Automated Kubernetes blue/green rolling deployment.

## 3. Release Purpose
The primary purpose of `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) is to deliver citizen intake workflows: demographic registration, abha m1 verification, repeat patient search, bilingual digital consent, and real-time station queue management. This release vehicle delivers an integrated, verified, and hardened milestone package, transitioning completed sprint outputs into production-grade capabilities.

## 4. Business Context
Operating across the municipal healthcare landscape of Bengaluru, the Namma Clinic Platform delivers high-quality primary healthcare services to urban communities. Release `RELEASE-01` provides the specific capabilities required to support clinical staff, reduce patient waiting times, eliminate manual paper logs, and enforce strict regulatory compliance with the Digital Personal Data Protection (DPDP) Act 2023.

## 5. Business Value
The strategic and operational business value realized through `RELEASE-01` includes:
- **Clinical Quality & Safety:** Reduces outpatient wait times by 40%, enforces DPDP Act 2023 patient consent capture, and links citizen records across municipal visits via ABHA.
...
The measurable engineering and clinical delivery objectives for `RELEASE-01` are:
...
## 7. Release Scope
The operational scope of `RELEASE-01` encompasses:
- **Functional Scope:** Patient registration form, ABHA M1 integration, phonetic search algorithms, repeat visit record linkage, DPDP-compliant consent logging, digital token generation, and multi-display queue boards.
...
## 8. Out-of-Scope
The following capabilities are explicitly declared out-of-scope for `RELEASE-01`:
...
Analysis of operational impacts on key program stakeholders for `RELEASE-01`:
...
## 10. Persona Impact
Direct operational impacts on frontline personas during `RELEASE-01`:
...
## 11. Role Impact
Impacts and accountabilities across the 17 engineering and operational delivery roles for `RELEASE-01`:
- **Product Manager:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Solution Architect:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Technical Lead:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Backend Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Frontend Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Database Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **QA Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Security Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **DevOps Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Clinical SME:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Integration Engineer:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.
- **Support/Operations:** Responsible for architectural design, code implementation, test automation, and sign-off for Core Patient Registration, Queue Management & Digital Consent.

## 12. Capability Map
Architectural capability mapping for `RELEASE-01` across core platform pillars:
### Architecture Diagram: Capability Hierarchy for RELEASE-01
<!-- DOCUMENTATION-ONLY DIAGRAM -->
```mermaid
graph TD
    subgraph Release_Capabilities [RELEASE-01: Core Patient Registration, Queue Management & Digital Consent]
...
## 13. Feature Map
Complete product feature allocation and verification matrix across all 180 platform product features for `RELEASE-01`:
...
## 14. Epic Map
Delivery epics linked to `RELEASE-01` increment:

- **Epic Identifier:** `EPIC-006` | Scope: `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-007` | Scope: `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-008` | Scope: `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-009` | Scope: `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE
- **Epic Identifier:** `EPIC-010` | Scope: `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) | Domain: Primary Healthcare Operations | Status: APPROVED BASELINE

## 15. Requirement Traceability
Upstream functional and non-functional requirements satisfied by `RELEASE-01`:
...
- **Requirement ID:** `PRIV-001` — Verified against Phase 02 Requirements baseline with full coverage.
- **Requirement ID:** `PRIV-002` — Verified against Phase 02 Requirements baseline with full coverage.

## 16. Workflow Traceability
Operational workflows realized in `RELEASE-01`:
...
Architectural components instantiated and verified in `RELEASE-01`:
- **Component:** `Patient Intake Service` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `Queue Engine` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `ABHA Gateway Adapter` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `Consent Store` — Aligned with Phase 06 Software Architecture specification.
- **Component:** `WebSocket Hub` — Aligned with Phase 06 Software Architecture specification.

## 18. Database Traceability
Complete database schema lineage across all 52 platform relational tables for `RELEASE-01`:
...
## 19. API Traceability
OpenAPI 3.1 REST API endpoint contracts delivered and verified in `RELEASE-01`:

- **API Family:** `Patient Registration API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Search API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Consent API` — Fastify route handlers with schema-validated input payloads.
- **API Family:** `Queue Management API` — Fastify route handlers with schema-validated input payloads.

### Configuration Specification Example: OpenAPI Contract for RELEASE-01
<!-- DOCUMENTATION-ONLY EXAMPLE -->
```yaml
# DOCUMENTATION-ONLY CONFIGURATION
# DOCUMENTATION-ONLY CONFIGURATION: API Endpoint Contract for RELEASE-01
openapi: 3.1.0
info:
  title: Namma Clinic RELEASE-01 API
  version: "v0.2.0-beta"
paths:
  /api/v1/release-01/status:
    get:
...
User interface modules and bilingual UX components delivered in `RELEASE-01`:
- **UI Module:** `Registration Counter Workbench` — Built with React, TailwindCSS, and verified Kannada/English string tokens.
- **UI Module:** `Queue Display Board` — Built with React, TailwindCSS, and verified Kannada/English string tokens.
- **UI Module:** `Consent Modal` — Built with React, TailwindCSS, and verified Kannada/English string tokens.

## 21. Security Traceability
Zero-trust security controls and cryptographic perimeters enforced in `RELEASE-01`:
- **Security Control:** `DPDP consent ledger` — Compliant with Phase 10 Security Architecture.
- **Security Control:** `AES-256 field-level PII encryption` — Compliant with Phase 10 Security Architecture.
- **Security Control:** `RBAC reception desk role limits` — Compliant with Phase 10 Security Architecture.

## 22. QA Traceability
Multi-tier quality assurance and automated test verification for `RELEASE-01`:
- **QA Strategy:** Playwright automated browser tests covering Kannada and English registration journeys.
...
CI/CD deployment pipelines, container images, and infrastructure manifests for `RELEASE-01`:
- **DevOps Controls:** WebSocket horizontal scaling via Redis pub/sub backplane in staging cluster.
- **Container Artifact:** Signed OCI container images published to GitHub Container Registry.

## 24. Data Traceability
Data engineering pipelines and lakehouse synchronization for `RELEASE-01`:
- **Data Capabilities:** Hourly clinic footfall counters and queue wait-time metrics.
- **Audit Logging:** Immutable WORM ledger recording all state transitions.

## 25. AI Traceability
Artificial intelligence and clinical decision support governance for `RELEASE-01`:
- **AI Capabilities:** None in intake tier.
- **Clinical Primacy:** Mandatory physician oversight; zero autonomous treatment algorithms.

## 26. Integration Traceability
External partner interfaces and gateway adapters configured for `RELEASE-01`:
- **Integration Gateway:** `ABHA Sandbox Gateway` — WireMock mock stubs active in local development.
- **Integration Gateway:** `CDAC SMS OTP Gateway` — WireMock mock stubs active in local development.

## 27. Sprint Mapping
Sprint increments constituting `RELEASE-01`:
...
Critical upstream and cross-squad dependencies for `RELEASE-01`:
...
## 29. Risk Mapping
Delivery and operational risks managed for `RELEASE-01`:
...
## 30. Blocker Mapping
Potential blockers and decoupled workarounds for `RELEASE-01`:
...
- **Impacted Scope:** Components linked to Core Patient Registration, Queue Management & Digital Consent release increment.
...
Master program milestones verified upon `RELEASE-01` completion:
...
## 32. Entry Criteria
Definition of Ready (DoR) required before entering `RELEASE-01` deployment phase:
- RELEASE-00 Foundation certified and active in staging environment.
- All pull requests reviewed by at least two senior engineers.
- Zero unhandled lint or formatting errors in source repository.

## 33. Exit Criteria
Definition of Done (DoD) required for `RELEASE-01` production promotion:
- 1,000 synthetic patient registrations executed with sub-250ms p95 search latency and 100% consent audit trail logging.
...
Operational and facility readiness parameters for `RELEASE-01`:
- Pilot registration desks equipped with barcode scanners and receipt printers.
- Staging load test validates sub-250ms p95 latency under simulated peak load.

## 35. Quality Gates
Automated quality gates enforced for `RELEASE-01` in CI/CD pipeline:
...
## 36. Security Gates
Security validation gates for `RELEASE-01`:
- Zero plain-text Aadhaar or PII numbers stored in database tables or logs.
- SAST, DAST, and container vulnerability scans completed with passing grade.

## 37. Data Gates
Database migration and data readiness gates for `RELEASE-01`:
- Pre-loaded municipal pin code directory and BBMP ward boundaries.
- Flyway migrations execute cleanly; reversible undo scripts tested in staging.

## 38. Operational Gates
SRE operational readiness gates for `RELEASE-01`:
- Registration desk operational manuals published in Kannada and English.
- Kubernetes liveness (`/healthz`) and readiness (`/readyz`) probes configured.

## 39. Training Gates
Frontline staff enablement gates for `RELEASE-01`:
- Training video module for clinic registration staff recorded and distributed.
- Bilingual user training guides distributed to participating clinic staff.

## 40. Support Gates
Helpdesk and support infrastructure gates for `RELEASE-01`:
- Tier-1 helpdesk trained on token printer and scanner troubleshooting.
- On-call rotation established and emergency escalation matrix published.

## 41. Deployment Strategy
Blue/Green zero-downtime deployment mechanism for `RELEASE-01`:
...
Automated and manual rollback protocols for `RELEASE-01`:
- **Rollback Trigger Criteria:** Canary deployment rollback if token generation error rate exceeds 1% during staging verification.
...
Formal decision governance for `RELEASE-01` deployment:
...
Formal acceptance criteria governing `RELEASE-01` sign-off:
- Frontline registration clerk completes citizen intake, ABHA verification, and token printing in under 90 seconds.

## 45. Metrics
Technical and engineering performance metrics monitored for `RELEASE-01`:
...
## 46. KPIs
Key public health and operational performance indicators for `RELEASE-01`:
...
Operating governance framework for `RELEASE-01`:
...
Standard change management procedures for `RELEASE-01`:
...
Stakeholder communication schedule for `RELEASE-01`:
...
Post-release validation protocol executed immediately following `RELEASE-01` cutover:
...
## 51. Hypercare
Dedicated hypercare support model for `RELEASE-01`:
...
## 52. Lessons Learned
Continuous improvement review protocol for `RELEASE-01`:
...
Multi-dimensional traceability matrix linking `RELEASE-01` across program dimensions:

| Dimension | Upstream Identifier | Verification Status |
| :--- | :--- | :--- |
| **Governing Sprints** | SPRINT-03, SPRINT-04, SPRINT-05 | VERIFIED & LINKED |
| **Governing Epics** | EPIC-006, EPIC-007, EPIC-008, EPIC-009 | VERIFIED & LINKED |
| **Primary Database Tables** | TABLE-011, TABLE-012, TABLE-013, TABLE-014, TABLE-015 | VERIFIED & LINKED |
| **Primary Requirements** | FR-005, FR-006, FR-007, FR-008 | VERIFIED & LINKED |
| **Primary Workflows** | WF-003, WF-004, WF-005, WF-006 | VERIFIED & LINKED |
| **Target Milestones** | MILESTONE-003, MILESTONE-004 | VERIFIED & LINKED |

## 54. Release Completion Checklist
20-point exhaustive release readiness checklist certifying completion of `RELEASE-01`:
...
The Enterprise Release Specification for `RELEASE-01` (Core Patient Registration, Queue Management & Digital Consent) has been formally reviewed, certified, and approved for execution:

| Authority Body | Designated Officer | Certification Status for RELEASE-01 |
| :--- | :--- | :--- |
| **Chief Technology Officer** | Chief Technology Officer | `APPROVED & CERTIFIED (RELEASE-01)` |
| **Lead Systems Architect** | Lead Solutions Architect | `APPROVED & CERTIFIED (RELEASE-01)` |
| **Lead Clinical SME** | Chief Medical Officer | `APPROVED & CERTIFIED (RELEASE-01)` |
| **Director of Health Services** | Joint Commissioner of Health | `APPROVED & CERTIFIED (RELEASE-01)` |
